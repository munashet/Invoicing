...
namespace Invoicing {
    public class Receipt: Document {
        ...
        const string MAIN_COLOR = "#339933";
        const string FONT_FAMILY = "Calibri";
        const int FONT_SIZE = 12;

        public Receipt(Order order, double vat)
            : base(order, vat) {
        }
        ...
        public override string GetTitle() {
            return "Receipt :: " + this.Order.Date.ToString("dd MMM, yyyy");
        }
        ...
        public override FlowDocument GetDocument() {
            ...
            p.TextAlignment = TextAlignment.Right;
            cell2.Blocks.Add(p);
            r = new Run("Receipt: " + DocumentNumberString);
            r.FontFamily = new FontFamily(FONT_FAMILY);
            r.FontSize = FONT_SIZE;
            p = new Paragraph(r);
            p.TextAlignment = TextAlignment.Right;
