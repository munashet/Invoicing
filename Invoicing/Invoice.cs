...
namespace Invoicing
{
    public class Invoice: Document {
        ...
        const string MAIN_COLOR = "#BFA57D";
        const string HEADER_COLOR = "#996633";
        ...
        //CONSTRUCTOR
        public Invoice(Order order, double vat)
            : base(order, vat) {
        }

        public override string GetTitle() {
            return "Invoice :: " + this.Order.Date.ToString("dd MMM, yyyy");
        }
        ...
        public override FlowDocument GetDocument() {
          ...
          // r.FontStyle = FontStyles.Italic;
            ...
            Brush brush = (Brush)bc.ConvertFrom(HEADER_COLOR);
            brush.Freeze();
            r.Foreground = brush;
            ...
            p.TextAlignment = TextAlignment.Right;
            cell2.Blocks.Add(p);
            r = new Run("Invoice: " + DocumentNumberString);
            r.FontFamily = new FontFamily(FONT_FAMILY);
            r.FontSize = FONT_SIZE;
            p = new Paragraph(r);
            p.TextAlignment = TextAlignment.Right;
            ...
            p.TextAlignment = TextAlignment.Left;
            cell.Blocks.Add(p);
            r = new Run("Due Date: " + this.DueDate.ToString ("MMM dd, yyyy"));
            r.FontFamily = new FontFamily(FONT_FAMILY);
            r.FontSize = FONT_SIZE;
            p = new Paragraph(r);
